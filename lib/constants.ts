...
export const CURRENCIES: CurrencyOption[] = [
  ...
  { value: "₨", label: "Sri Lankan Rupee (LKR) " },
  ...
  { value: "₨", label: "Mauritian Rupee (MUR) " },
  ...
  { value: "C$", label: "Nicaraguan Córdoba (NIO) " },
  { value: "NOK", label: "Norwegian Krone (NOK) " },
  { value: "₨", label: "Nepalese Rupee (NPR) " },
  { value: "NZ$", label: "New Zealand Dollar (NZD) " },
  { value: "﷼", label: "Omani Rial (OMR) " },
  ...
  { value: "$", label: "Solomon Islands Dollar (SBD) " },
  { value: "₨", label: "Seychellois Rupee (SCR) " },
  ...
  { value: "$", label: "United States Dollar (USD) " },
