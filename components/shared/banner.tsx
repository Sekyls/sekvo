...
export default function Banner() {
  return (
    <div className="flex flex-col justify-center items-center mt-10 space-y-5 text-center">
      <h1>Sekvo</h1>
      ...
      <Button className="flex gap-x-2 items-center justify-center p-6 font-bold primary-gradient">
      ...
      <Image
        ...
        width={600}
        height={600}
        className="ml-48 drop-shadow-md drop-shadow-foreground"
      />
    </div>
  );
}
